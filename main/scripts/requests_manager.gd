...
func get_all_users() -> FirestoreTask:
	return Firebase.Firestore.list("sociadot/340b3IJqqSEK1kMijHCC/users", 50)
...
func delete_post(post_id : String) -> FirestoreTask:
	return (posts_collection.delete(post_id))
